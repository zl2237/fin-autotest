"""
测试链路 28：订单+应收（receive_pay），确认应付对账
执行顺序：订单 1~12 步 + 应收 1~6 步 + 应付 1~2 步
前置条件：应付 1 步完成
"""
...
@pytest.mark.order_receive_pay8
class TestOrderReceivePay8ConfirmPayable:

    @allure.severity("critical")
    def test_order_receive_pay8_confirm_payable(self):
        bl_no = generate_bl_no(208)
