"""
测试链路 26：订单+应收（receive_pay），应收核销
执行顺序：订单 1~12 步 + 应收 1~5 步
前置条件：应收 4 步完成
"""
...
@pytest.mark.order_receive_pay6
class TestOrderReceivePay6ReceiveWriteoff:

    @allure.severity("critical")
    def test_order_receive_pay6_receive_writeoff(self):
        bl_no = generate_bl_no(206)
