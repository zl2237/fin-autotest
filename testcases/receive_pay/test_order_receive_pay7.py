"""
测试链路 27：订单+应收（receive_pay），发起应付对账批次
执行顺序：订单 1~12 步 + 应收 1~6 步 + 应付 1 步
前置条件：应收 4 步完成
"""
...
@pytest.mark.order_receive_pay7
class TestOrderReceivePay7PayableAccount:

    @allure.severity("critical")
    def test_order_receive_pay7_payable(self):
        bl_no = generate_bl_no(207)
